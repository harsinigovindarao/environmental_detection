...
def send_email(subject, body, to_email, app_password, attachment_path):
    email = 'harsinigovindarao24@gmail.com'  # Update with your email
...
if _NamedFuncPointer == "_main_":
    app_password = "oalg cyed nxwl cmee"  # Update with your app password
    subject = "scrapped information"
    body = ""  # Leave body empty for now
    recipient_email = "sahanaganesh501@gmail.com"
